...
- (id)initWithDelegate:(id)delegate userData:(long)userData enableIPv4:(BOOL)enableIPv4 enableIPv6:(BOOL)enableIPv6 customObject:(NSObject *)obj
{
   if((self = [super init]))
   {
      theFlags = 0;
...
- (id)init
{
   return [self initWithDelegate:nil userData:0 enableIPv4:YES enableIPv6:YES customObject:nil];
}

- (id)initWithDelegate:(id)delegate
{
   return [self initWithDelegate:delegate userData:0 enableIPv4:YES enableIPv6:YES customObject:nil];
}

- (id)initWithDelegate:(id)delegate
        customCallback:(NSObject *)obj
{
   return [self initWithDelegate:delegate userData:0 enableIPv4:YES enableIPv6:YES customObject:obj];
}

- (id)initWithDelegate:(id)delegate userData:(long)userData
{
   return [self initWithDelegate:delegate userData:userData enableIPv4:YES enableIPv6:YES customObject:nil];
}

- (id)initIPv4
{
   return [self initWithDelegate:nil userData:0 enableIPv4:YES enableIPv6:NO customObject:nil];
}

- (id)initIPv6
{
   return [self initWithDelegate:nil userData:0 enableIPv4:NO enableIPv6:YES customObject:nil];
}
